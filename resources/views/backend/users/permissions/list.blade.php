...
@section('content')
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3>Permissions <a href="{{ route('addpermission') }}"><button class="btn btn-primary">Add Permission</button></a></h3>
          </div>
          <div class="col-sm-6">
                ...
                <table id="example1" class="table table-bordered table-striped mt-3">
                  ...
                  <tr>
                    ...
                    <td class="project-actions">
                          <a class="btn btn-info btn-sm" href="{{ route('editpermission', ['id' => $permission->id]) }}">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Edit
                          </a>
                          <form method="POST" action="{{ route('deletepermission', ['id' => $permission->id]) }}" style="display: inline-block;">
                            @csrf
