...
@section('content')
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3>UserRoles <a href="{{ route('addUserRole') }}"><button class="btn btn-primary">Add UserRole</button></a></h3>
          </div>
          <div class="col-sm-6">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped mt-3">
                  ...
                  <tr>
                    ...
                    @if($role->status == '1') <span class="badge badge-success">Active</span>
                    @elseif($role->status == '2') <span class="badge badge-danger">Deactive</span>
                    @endif</td>
                      <td class="project-actions">
                          <a class="btn btn-info btn-sm" href="{{ route('editUserRole', ['id' => $role->id]) }}">
                              <i class="fas fa-pencil-alt">
                              </i>
                              Edit
                          </a>
                          <form method="POST" action="{{ route('deleteUserRole', $role->id) }}" style="display: inline-block;">
                            @csrf
